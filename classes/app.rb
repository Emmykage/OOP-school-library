...
class App
    ...
    def create_student
        ...
        @persons.push(Student.new(s_age, s_name))
    ...
    def list_rental
        ...
        selected_person =  @persons.find {|person| person.id == p_id}
        
       select_rentals =  selected_person.rentals
       select_rentals.each {| rental | puts "Name: #{rental.person.name}, Book:  #{rental.book.title}"}
